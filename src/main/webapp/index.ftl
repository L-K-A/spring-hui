...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="statics/Hui-iconfont/1.0.8/iconfont.css" />
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">${userinfo[0].personname}<i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="#" onclick="myselfinfo(${userinfo[0].pid})">个人信息</a>
                            </li>
                            <li><a href="#">切换账户</a></li>
                            <li><a href="#">退出</a></li>
                        </ul>
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-href="artic-list.ftl" data-title="资讯管理" href="javascript:void(0)">
                            资讯管理</a></li>
                </ul>
            </dd>
        </dl>
...
<script type="text/javascript"  >
    ...
    var myselfinfo=function (pid) {
        layer.open({
            ...
            shadeClose:true,
            area: ['500px','500px'],
            content: '/getadmininfo.action?pid='+pid
        });
    }
</script>
</body>
